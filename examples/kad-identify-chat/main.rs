...
//! and the Kademlia DHT for peer discovery and routing.
...
//!
//! A secondary purpose of this example is to show what integration of libp2p in a more complex
//! application might look like. It implements a `Network` component that wraps the `Swarm` and a
//! network client that communicates with it through mpsc channels. It is similar in that respect
//! to the file-sharing example.
//!
